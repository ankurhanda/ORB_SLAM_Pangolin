...
//    string strSettingsFile = "/home/ankur/workspace/code/ORB_SLAM"+"/"+argv[2];

//    cv::FileStorage fsSettings(strSettingsFile.c_str(), cv::FileStorage::READ);
//    if(!fsSettings.isOpened())
//    {
//        std::cout<<"Wrong path to settings. Path must be absolut or relative to ORB_SLAM package directory."<<std::endl;
////        ros::shutdown();
//        return 1;
//    }
...
//    string strFile = "/home/ankur/code/ORB_SLAM"+"/"+"KeyFrameTrajectory.txt";
